...
let homeSectionNoteCardEl = document.getElementById("homeSectionNoteCard")
let homeSectionNoteCardNoteEl = document.getElementById("homeSectionNoteCardNote")
let homeSectionNoteCardNoteInputEl = document.getElementById("homeSectionNoteCardNoteInput")
let homeSectionNoteCardIconEl = document.getElementById("homeSectionNoteCardIcon")
let homeSectionNoteCardPenEl = document.getElementById("homeSectionNoteCardPen")
let homeSectionNoteCardDeleteEl = document.getElementById("homeSectionNoteCardDelete")
homeSectionNoteCardIconEl.onclick = function() {
